...
#define INTERVALS 30
#define MAX_DAYS_FEB_LEAP 29 
#define MAX_DAYS_FEB 28 
#define MAX_DAYS31 31 
#define MAX_DAYS30 30
...
//void removeAppointment(struct ClinicData* appoint, struct ClinicData* maxappoint, struct ClinicData* patient, struct ClinicData* maxpatient);
